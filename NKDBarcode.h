...
@header NKDBarcode.h
 ...
 implement a variety of one dimensional (linear) barcodes. Subclasses will respond to a barcode message by
 ...
 because this is an acceptable for most barcodes and many inkjet and laser printers have insufficient resolution to
 produce a readable code on plain paper at smaller than this size.
 ...
 the creation of readable code for any given hardware - I've done the best job that I could on this armed only with my PowerBook,
 a Cue Cat and my code.
 ...
 please send it to me at <code>jeff_lamarche&#064;mac.com</code> or <code>naked_software&#064;mac.com</code> and I will try to
 respond. Support for 2-dimensional (matrix) barcodes is not currently planned as part of this framework, but if there's an
 interest, I'll consider adding it. 
*/
